...
## Sprint 1
- Project setup 
- Initial Analysis of design issues  
- Initial implementation of new features
- Initial refactoring of base tetris game 
...
- Completely polished original game
- Completion of expected features 
- Possible micro additions if time allows
